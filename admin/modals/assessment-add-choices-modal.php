                ...
                <form id="assessment-choice-add" name="assessment-choice-add" method="post">
                    <div class="row datatable">
                        <div class="col-12">
                            ...
                            <select class="form-select" aria-label="Default select example" onChange="check();" name="assessment-choice-add-title" id="assessment-choice-add-title">
                            ...
                            <input type="hidden" name="assessment_id" id="assessment-choice-id" />
                        <div class="col-12">
                            <label for="name">Assessment Question</label>
                            <textarea class="form-control" name="assessment-choice-question" id="assessment-choice-question" value=""></textarea>
                        </div>
                        <div class="col-12">
                            <label for="name">Choice 1</label>
                            <input type="text" class="form-control" name="assessment-choice-add-ch1" id="assessment-choice-add-ch1" value="">
                        </div>
                        <div class="col-12">
                            <label for="name">Choice 2</label>
                            <input class="form-control" name="assessment-choice-add-ch2" id="assessment-choice-add-ch2" value=""></textarea>
                        </div>
                        <div class="col-12">
                            <label for="name">Choice 3</label>
                            <input type="text" class="form-control" name="assessment-choice-add-ch3" id="assessment-choice-add-ch3" value="">
                        </div>
                        <div class="col-12">
                            <label for="name">Choice 4</label>
                            <input class="form-control" name="assessment-choice-add-ch4" id="assessment-choice-add-ch4" value=""></textarea>
                        </div>
                        <div class="col-12">
                            <label for="name">Correct Answer</label>
                            <input class="form-control" name="assessment-choice-add-answer" id="assessment-choice-add-answer" value=""></textarea>
                        </div>
                    </div>
            </div>
