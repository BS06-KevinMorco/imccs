    ...
    <script src="assets/js/ajax/student-faculty-crud.js"></script>
    <script src="assets/js/ajax/institution-crud.js"></script>
        ...
        $(document).ready(function() {
            ...
            $('table.admin').DataTable({
                ...
                buttons: [
                    ...
                    {
                        extend: 'copyHtml5',
                        text: '<i class="fa-solid fa-clipboard"></i> Copy',
                        titleAttr: 'Copy'
                    },
                    {
                        extend: 'excelHtml5',
                    ...
                    {
                        extend: 'csvHtml5',
                        text: '<i class="fa-solid fa-file-csv"></i> CSV File',
                        titleAttr: 'CSV'
                    },
                    {
                        extend: 'pdfHtml5',
    ...
    <!-- SCRIPT FOR RETAINING SIDEBAR ACTIVE STATE ON PAGE RELOAD -->
    <script>
        $(function($) {
