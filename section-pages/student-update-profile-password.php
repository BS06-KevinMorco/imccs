...
<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <a href="home-student.php?page=student-browse-topics" class="logo d-flex align-items-center">
...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link student-update" href="home-student.php?page=student-update-profile-password&subpage=personal-info" data-id="<?php echo $_SESSION['user_id'] ?>">
        ...
        <li class="nav-item">
            <a class="nav-link student-update" href="home-student.php?page=student-update-profile-password&subpage=change-password">
