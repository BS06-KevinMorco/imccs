...
<div class="d-flex justify-content-end mt-4 mx-4">
    <form class='searchbox'>
        <input class="form-control searchbar" type="text" placeholder="Search Assessments" name="search">
    </form>
</div>

<section class="student-browse-assessment">
    <div class="row">
        ...
        <div class="assessment-card-container col-sm-12 col-md-8 col-lg-9 d-flex">
...
<script>
    $(".searchbar").keyup(function() {
        ...
        $('.assessment-card-container .col-lg-6 .topic-card h3').each(function() {
...
<script>
    $(document).ready(function() {
        ...
        function filter_data() {
            ...
            $.ajax({
                url: "query/filter-assessment.php",
                method: "POST",
                data: {
                    action: action,
