...
<!-- ====== Login Start ====== -->
<section class="login-section" style="min-height:130vh; overflow:hidden;">
    <a href="javascript:void(0)" onclick="history.back()" class="btn-custom-secondary" style="top:10px; position:absolute;"><i class="fa-solid fa-arrow-left"></i> Go Back</a>

    <div class="row">
        <div class="login-section-wrapper" style="padding: 50px 50px;">
