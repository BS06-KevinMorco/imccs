                ...
                <div class="contact-form-wrapper wow fadeInUp" data-wow-delay=".2s">
                    ...
                    <form action="javascript:void(0)" class="contact-form"  method="POST">
                        <div class="index-form-group">
                            ...
                            <input type="text" name="fullname" id="fullname" placeholder="Adam Gelius" />
                        </div>
                        <div class="index-form-group">
                        ...
                        <div class="index-form-group">
                            ...
                            <input type="text" name="mobile_no" id="mobile-no" placeholder="+885 1254 5211 552" required />
                        </div>
                        <div class="index-form-group">
                            <label for="message">Message*</label>
                            <textarea name="feedback_message" id="feedback-message" rows="1" placeholder="type your message here" required></textarea>
                        </div>
